...
<body>
   ...
   <table margin="auto">
         <tr>
            <td width="30%">
               <center>
                     <font size="5">Data Penerima Bantuan Sosial Yang Tidak Direkomendasikan</font><br>
               </center>
            </td>
         </tr>
   </table>
   ...
   <table margin="100%">
         ...
         <tr>
            <td><font size="3">Jumlah Yang Tidak Menerima BANSOS </font></td>
            <td><font size="3">:</font></td>
            <td><font size="3">'.$jml_unrekom.' KK</font></td>
         </tr>
   </table>
