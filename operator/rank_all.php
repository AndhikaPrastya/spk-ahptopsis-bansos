...
<div class="main-content">
  <section class="section">
      <div class="section-header">
        <h1>Rangking Penilaian Semua Data Alternatif</h1>
      </div>
       <h2 class="section-title"><b>Laporan </b>: <?=$laporan['nama'];?> <b>[</b> <?= date('d M Y H:i:s', strtotime($laporan['time_input']));?> <b>]</b></h2>
      <h2 class="section-title"><b>Jumlah Semua Warga </b>: <?=$jml_alt?> Orang </h2> 
      <h2 class="section-title"><b>Jumlah Penerima BANSOS </b>:  <?=$laporan['kuota']?> Orang </h2>
      <h2 class="section-title"><b>Jumlah Yang Tidak Menerima BANSOS </b>:  <?=$jml_unrekom?> Orang </h2> 
      <!-- Begin form content -->
      <div class="section-body">
           <div class="card">
              <div class="card-footer bg-whitesmoke">
                <a class="btn btn-success float-right" href="../cetak_all.php?id_laporan=<?=$id_laporan?>" target="_blank" role="button">
