...
$id=$_SESSION['id'];
$user=query("SELECT a.id, a.nama, a.email, a.username, a.password, a.time_input, b.role 
                ...
                <div class="card profile-widget">
                  ...
                  <div class="profile-widget-description">
                    ...
                    <i class="fas fa-envelope"></i> Email : <span><?=$user['email']?></span><br>
                     <i class="fas fa-calendar-check"></i> Bergabung sejak : <span><?= date('d M Y', strtotime($user['time_input']))?></span><br>
                      <div class="card-footer bg-whitesmoke" >
                      <button type="button" class="btn btn-sm btn-success float-right" data-toggle="modal" 
                          data-target="#modalPass"> <i class="fas fa-key"></i> Change Password
                      </button>
                      <button type="button" class="btn btn-sm btn-info float-right" data-toggle="modal" 
                          data-target="#modalEdit"> <i class="fas fa-user-edit"></i> Edit Profile
                      </button>
                    </div>
                  </div>
                </div>
