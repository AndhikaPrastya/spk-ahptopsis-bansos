              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-footer bg-whitesmoke">
                    ...
                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modalImport"> <i class="fas fa-file-excel"></i>
                    Import Excel
                    </button>
...
<!--                                       <td class="text-center"><?= date('d M Y H:i:s', strtotime($row['time_input']));?></td>
      ...
      <!-- End form content -->
        ...
        <div class="card-footer bg-whitesmoke">
         <a class="btn btn-success float-left " href="r_alternatif.php" role="button"><i class="fas fa-recycle"></i> Recycle Bin</a>
       </div>
  </section>
</div>
<!-- End Main Content -->
